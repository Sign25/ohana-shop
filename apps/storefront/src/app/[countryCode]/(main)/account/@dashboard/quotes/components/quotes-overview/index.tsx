...
const QuotesOverview = ({
  ...
  return (
    <div className="w-full flex flex-col items-center gap-y-4">
      <h2 className="text-large-semi">Запросов пока нет</h2>
      <p className="text-base-regular">Соберите корзину и нажмите «Запросить спеццену» — менеджер ответит предложением.</p>
