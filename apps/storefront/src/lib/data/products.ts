    ...
    .fetch<{ products: HttpTypes.StoreProduct[] }>(`/store/products`, {
      ...
      query: {
        ...
        fields:
          ...
          "*variants,*variants.calculated_price,+variants.inventory_quantity,+variants.metadata,+metadata,*categories,*images",
      },
      headers,
      next,
    })
  ...
  return sdk.client
    .fetch<{ products: HttpTypes.StoreProduct[] }>(`/store/products`, {
      ...
      query: {
        ...
        region_id: regionId,
        fields:
          "*variants.calculated_price,+variants.inventory_quantity,+variants.metadata,+metadata,+tags,*categories",
      },
      headers,
      next,
    })
